...
class TestWalkForwardSplit:
    ...
    def test_sklearn_timeseriessplit_equivalence_when_no_purge(self) -> None:
        """With purge_horizon=embargo=0, non-overlapping (zero-length) labels
        and expanding mode, WalkForwardSplit must produce the same folds as
        sklearn's TimeSeriesSplit. One-step labels [t, t+1] would touch their
        neighbours and be purged under AFML's closed intervals."""
