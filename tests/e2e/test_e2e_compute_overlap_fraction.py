...
def test_user_story_partial_leakage_quantified() -> None:
    """7-day overlapping labels: 7 of 20 training rows leak into test.

    Test starts Jan 21 (pred[20]). Train rows 0..12 have evalu ranging
    Jan 8..Jan 20 — all before Jan 21, so no overlap. Row 13 ends exactly
    on Jan 21 and touches the test horizon (closed intervals, AFML 7.4.1);
    rows 14..19 have evalu Jan 22..Jan 27, all overlapping [Jan 21, Feb 6].
    That is exactly 7 of 20 → 0.35.
    """
