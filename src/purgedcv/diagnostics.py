...
from purgedcv._intervals import overlaps_any_closed_interval, points_in_any_closed_interval
...
def _overlap_fraction_from_arrays(
    ...
    overlaps = overlaps_any_closed_interval(train_pred, train_eval, test_starts, test_ends)
...
def assert_no_temporal_leakage(
    ...
    *,
    ...
    Test horizons are checked as a union of closed intervals, not as one
...
def compute_overlap_fraction(
    ...
    *,
    ...
    """Return the fraction of training rows whose closed label horizon
