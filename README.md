...
| `embargo_observations=10` | Drop the next 10 row positions after each test block's labels end |
| `embargo_fraction=0.01` | Drop the next `floor(n_samples * 0.01)` row positions after each test block's labels end |
